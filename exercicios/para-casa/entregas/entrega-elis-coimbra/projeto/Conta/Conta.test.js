...
describe("Testes da Classe Conta", () => {
  ...
  test("retornar mensagem de erro ao tentar cadastrar chave pix com email invalido", () => {
    ...
    //verificacao
    expect(() => conta.criarChavePix("aa", "EMAIL")).toThrow("Erro: Email inválido");
  ...
  test("retornar mensagem de erro ao tentar cadastrar chave pix com telefone invalido", () => {
    ...
    //verificacao
    expect(() => conta.criarChavePix("34a", "TELEFONE")).toThrow("Erro: Telefone inválido");
...
test("retorna sucesso ao fazer uma transferencia com valor válido, saldo suficiente, dados validos", ()=>{
  ...
  contaEmissor.criarConta("0001", "12345", 1000 )
  contaReceptor.criarConta("0001", "78945", 500 )
  contaReceptor.criarChavePix("eliscoimbramoura@gmail.com", "EMAIL") 
  //acao
 const operacao = contaEmissor.transferirViaPix(100, "eliscoimbramoura@gmail.com", "email")
  //verificacao
...
test("retorna sucesso ao fazer uma transferencia com valor válido, saldo insuficiente e dados validos", ()=>{
  //setup
  const contaEmissor = new Conta();
  const contaReceptor = new Conta();
  contaEmissor.criarConta("0001", "12345", 1000 )
  ...
  contaReceptor.criarChavePix("eliscoimbramoura@gmail.com", "EMAIL") 
  //acao
 const operacao = contaEmissor.transferirViaPix(9000, "eliscoimbramoura@gmail.com", "email")
  //verificacao
...
test("retorna sucesso ao fazer uma transferencia com valor válido, saldo suficiente e dados invalidos", ()=>{
  ...
  contaReceptor.criarChavePix("eliscoimbramoura@gmail.com", "EMAIL") 
  //acao
 const operacao = contaEmissor.transferirViaPix(100, "aa", "email")
  //verificacao
...
test("retorna sucesso ao fazer uma transferencia com valor inválido, saldo suficiente e dados validos", ()=>{
 ...
 const operacao = contaEmissor.transferirViaPix(-100, "eliscoimbramoura@gmail.com", "email")
  //verificacao
  expect(operacao).toBe("Valor invalido de Pix")
})
