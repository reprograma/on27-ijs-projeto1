...
describe("Teste da classe Cliente", ()=>{
    ...
    test("cadastrar cliente com dados válidos", ()=>{
        ...
        expect(cliente.registrar("Bia", "121564943121", conta)).toBe("Cliente Cadastrado")
    })

    test("retorne mensagem de erro quando tenta cadastrar cliente sem uma conta", ()=>{
        const cliente = new Cliente();

        expect(() => cliente.registrar("Bia", "121564943121", "nao conta")).toThrow("Erro no cadastro, dados inválidos")
