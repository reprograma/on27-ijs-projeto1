...
describe("Testes da Classe Conta Standard", () => {
  ...
  test("retorna mensagem de erro ao transferir valor acima de 1000 reais da conta", () => {
    const contaEmissor = new ContaStandard();
    const contaReceptor = new ContaStandard();
    ...
    expect(() => contaEmissor.transferir(2134, "0001", "78945")).toThrow("Erro: Valor de Transferência acima do limite diário de R$1.000,00");
  ...
  test("retorna mensagem de erro ao transferir via Pix valor acima de 1000 reais", () => {
    const contaEmissor = new ContaStandard();
    const contaReceptor = new ContaStandard();
    ...
    expect(() => contaEmissor.transferirPix(1788, "86687438050", "cpf")).toThrow("Erro: Valor de Transferência Pix acima do limite diário de R$1.000,00");
    expect(contaEmissor.getSaldo()).toBe(1000)
    expect(contaReceptor.getSaldo()).toBe(500)
